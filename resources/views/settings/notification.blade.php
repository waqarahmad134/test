                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-20">
                            ...
                            <input type="text" class="form-control radius-8" id="firebaseAuthDomain" placeholder="Firebase  AUTH Domain" value="CTS.firebaseapp.com">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-20">
                            <label for="firebaseProjectID" class="form-label fw-semibold text-primary-light text-sm mb-8">Firebase Project ID</label>
                            <input type="text" class="form-control radius-8" id="firebaseProjectID" placeholder="Firebase Project ID" value="CTS.com">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-20">
                            ...
                            <input type="text" class="form-control radius-8" id="firebaseStorageBucket" placeholder="Firebase Storage Bucket" value="CTS.appsport.com">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-20">
