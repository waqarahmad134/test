...
<input id="from" type="hidden" value="{{$request->from}}">
<input id="to" type="hidden" value="{{$request->to}}">
<input id="type" type="hidden" value="{{$request->type}}">
...
<div class="section__content section__content--p30">
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Civil Institutions</h3>
