...
@section('content')
        ...
        <div
            ...
            <div class="d-flex align-items-center flex-wrap gap-3">
                <form action="" method="GET" class="d-flex gap-2">
                    ...
                    <button type="button" class="btn btn-secondary clear-filter-btn" style="display: none;">Clear
                        Filter</button>
                </form>
            </div>

            <div class="d-flex gap-2">
                <a href="{{ route('cases.create.civil') }}"
                    class="btn btn-success text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2">
                    <iconify-icon icon="ic:baseline-plus" class="icon text-xl line-height-1"></iconify-icon>
                    Civil/Family
                </a>
                <a href="{{ route('cases.create.criminal') }}"
                    class="btn btn-success text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2">
                    <iconify-icon icon="ic:baseline-plus" class="icon text-xl line-height-1"></iconify-icon>
                    Criminal
                </a>
                <a href="{{ route('cases.create.misc') }}"
                    class="btn btn-success text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2">
                    <iconify-icon icon="ic:baseline-plus" class="icon text-xl line-height-1"></iconify-icon>
                    Misc.
                </a>
                        ...
                        @forelse($cases as $index => $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('finalprint/' . $product->id) }}" class="btn btn-warning btn-sm"
                        ...
                        <form id="productFormNew" name="productFormNew" class="needs-validation" novalidate>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="border rounded p-3" id="images-container-new" style="min-height: 150px;">
                                        <div class="text-muted text-center py-3" id="no-images-message">No images added yet.
                                            Use capture or upload to add images.</div>
                                        <div class="row g-2" id="images-gallery-new"></div>
                                    </div>

                                    <div class="d-flex gap-2 mt-3">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalNew" data-bs-dismiss="modal">
                                        ...
                                        <input type="file" id="file-upload-new" name="images[]" multiple accept="image/*"
                                            style="display: none;">
                                    </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cnic_new" name="cnic"
                                            placeholder="XXXXX-XXXXXXX-X" required>
                                        <small class="form-text text-danger" id="cnic_error_new"
                                            style="display: none;">Please enter a valid Pakistani CNIC format
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="form-text text-danger" id="check1_new">Case already entered 4
                                        times</small>
                                </div>
                            </div>
    ...
    <!-- Camera Modal - New UI -->
    <div class="modal fade text-center" id="exampleModalNew" tabindex="-1" aria-labelledby="exampleModalNewLabel"
        aria-hidden="true">
                ...
                <div class="modal-body px-4 pt-0">
                    <form id="productForm1New" name="productForm1New" class="form-horizontal">
                        ...
                        <div class="camera-box my-3 p-2 border rounded bg-light">
                            <div id="my_camera_new" class="w-100 rounded"
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="button" class="btn btn-primary px-4" onclick="take_snapshot_new()"
