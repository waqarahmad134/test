...
<div class="section__content section__content--p30">
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Institutions Management</h3>
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small" href="javascript:void(0)" id="createNewProduct" >
                                            <i class="zmdi zmdi-plus" ></i>Create New Institution</button>
...
<p class="text-center text-primary"><small> </small></p>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <button class="au-btn au-btn-icon au-btn--green au-btn--small" href="javascript:void(0)" id="createNewProduct" >
      <i class="zmdi zmdi-plus" ></i>Capture Image</button>
    <p style="font-size:20px"> Basic Info1 </p>
</div>
...
<div class="col-xs-12 col-sm-12 col-md-6">
        <div class="form-group">
            <strong>Appeal Category:</strong>
            <select class="form-control form-select sid" type="text" id="jur" name="jur" >
                <option value=""> Select </option>
                    <option value="Appellant Jurisdiction (Appeal/Revision)"  >(Appeal/Revision)</option>
