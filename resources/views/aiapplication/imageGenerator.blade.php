        ...
        <div class="chat-main card overflow-hidden">
            <div class="chat-sidebar-single gap-8 justify-content-between cursor-default flex-nowrap">
                <div class="d-flex align-items-center gap-16">
                    <a href="{{ route('textGenerator') }}" class="text-primary-light text-2xl line-height-1"><i class="ri-arrow-left-line"></i></a>
            ...
            <div class="chat-message-list max-h-612-px min-h-612-px">
                ...
                <div class="d-flex align-items-start justify-content-between gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                    <div class="d-flex align-items-center gap-16">
                        <div class="img overflow-hidden flex-shrink-0">
                            <img src="{{ asset('assets/images/chat/1.png') }}" alt="image" class="w-44-px h-44-px rounded-circle object-fit-cover">
                        </div>
                        <div class="info">
                ...
                <!-- CTS generated Text Start -->
                <div class="d-flex align-items-start gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                    <div class="img overflow-hidden flex-shrink-0">
                        <img src="{{ asset('assets/images/wow-dash-favicon.png') }}" alt="image" class="w-44-px h-44-px rounded-circle object-fit-cover">
                    </div>
                    <div class="info flex-grow-1">
                        <h6 class="text-lg mb-16 mt-8">CTS</h6>

                        <div class="row g-3">
                            <div class="col-xl-3 col-sm-6">
                                <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                    <img src="{{ asset('assets/images/chatgpt/image-generator1.png') }}" alt="" class="w-100 h-100 object-fit-cover">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                    <img src="{{ asset('assets/images/chatgpt/image-generator2.png') }}" alt="" class="w-100 h-100 object-fit-cover">
                                    <div class="form-check style-check d-flex align-items-center position-absolute top-0 start-0 ms-8 mt-8">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                    <img src="{{ asset('assets/images/chatgpt/image-generator3.png') }}" alt="" class="w-100 h-100 object-fit-cover">
                                    <div class="form-check style-check d-flex align-items-center position-absolute top-0 start-0 ms-8 mt-8">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                    <img src="{{ asset('assets/images/chatgpt/image-generator4.png') }}" alt="" class="w-100 h-100 object-fit-cover">
                                    <div class="form-check style-check d-flex align-items-center position-absolute top-0 start-0 ms-8 mt-8">
            ...
            <form class="chat-message-box">
                <input type="text" name="chatMessage" placeholder="Message CTS...">
